...
/**
 * 重写FileAppender类 让log4j在按日期分文件记录的基础上实现日志清理策略
 *
 * @author Mike.Peng
...
public class MyDailyRollingFileAppender extends FileAppender {
  ...
  public MyDailyRollingFileAppender(Layout layout, String filename, String datePattern)
      throws IOException {
...
/**
 * MyDailyRollingFileAppender的内部类 提供周期类型和当前时间 ，计算并返回下一个周期的开始时间
 *
 * @author Mike.Peng
...
class RollingCalendar extends GregorianCalendar {
  ...
  /**
   * RollingCalendar构造器 根据地点时区 ，获取对应的日历Calendar
   *
   * @param tz
   * @param locale
   */
